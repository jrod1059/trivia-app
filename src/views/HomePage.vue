...
<div class="grid flex-grow grid-cols-4 gap-12 m-20">
  ...
  class="bg-white text-center flex h-32 items-center justify-center rounded-lg border-4 border-red-600 py-4 font-bold uppercase hover:cursor-pointer hover:border-red-500 hover:bg-blue-600 transition-colors duration-300"
